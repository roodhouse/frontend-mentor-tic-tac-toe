...
function GameOn({turn, changeTurn, theCompetition, choice, xScore, oScore, ties, roundOver, xArray, oArray, playerXarray, playerOarray}) {
  return (
    <>
        <div id="gameOnContainer">
            ...
            <div id="gameGridWrapper">
                <GameGrid turn={turn} changeTurn={changeTurn} roundOver={roundOver} xArray={xArray} oArray={oArray} playerXarray={playerXarray} playerOarray={playerOarray} />
            </div>
